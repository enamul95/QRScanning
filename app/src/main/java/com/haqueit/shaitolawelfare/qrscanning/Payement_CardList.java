...
public class Payement_CardList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Payement_CardList.this, Code_Scanner.class);
    ...
    void showCardList() {
        ...
        // ListView
        recyclerView.setLayoutManager(new LinearLayoutManager(Payement_CardList.this));
            ...
            public ViewHolder(View itemLayoutView) {
                ...
                itemLayoutView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent(Payement_CardList.this, Payment_Scan_Qr.class);
                        startActivity(intent);
